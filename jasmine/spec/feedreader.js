...
$(function() {
    ...
    */
    ...
    describe('The Menu', function() {
        //var hidden_menu = ($('body').hasClass('menu_hidden')).toBe(true);
    ...
    describe('Initial Entries', function() {
         ...
         */
        it('contains at least a single entry element in feed container', function(done) {
    ...
    describe('News Feed Selection', function() {
         ...
         */
        it('when feed is selected content changes', function() {
